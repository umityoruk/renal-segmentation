...
def autoSegmentFromDicom(input_dir, output_dir=None, threshold_multiplier=1):
	...
	gc_labels_ss = renal_segment_v4(recon_ss, temp_res, spacing, threshold_multiplier=threshold_multiplier)
	...
	models_path = '/Users/umityoruk/Documents/PythonDev/FinalSegmentation/Models'
